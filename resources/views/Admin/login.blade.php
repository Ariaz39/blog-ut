...
<head>
    ...
    <title>Spur - Login</title>
</head>

<body>
<div class="form-screen">
    <a href="index.html" class="spur-logo"><i class="fas fa-bolt"></i> <span>Blog UT</span></a>
        ...
        <div class="card-body">
            <form action="#!">
                ...
                <div class="account-dialog-actions">
                    ...
                    <a class="account-dialog-link" href="signup.html">Crear una nueva cuenta</a>
                </div>
            </form>
        </div>
    </div>
